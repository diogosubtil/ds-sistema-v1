                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="<?php echo $obUnidade->cep ?>" id="cep" name="cep" placeholder="CEP">
                                        </div>
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" value="<?php echo $obUnidade->dataAbertura ?>" id="dataAbertura" name="dataAbertura" placeholder="Data de Abertura">
                                        </div>
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="<?php echo $obUnidade->whatsapp ?>" id="whatsapp" name="whatsapp" placeholder="Whatsapp">
                                        </div>
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" value="<?php echo $obUnidade->meta ?>" id="meta" name="meta" placeholder="Meta">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="gerente" id="gerente" class="form-control">
                                                ...
                                                <?php foreach ($usuarios as $usuario) { ?>
                                                    <option value="<?php echo $usuario->id ?>" <?php if ($usuario->id == $obUnidade->gerente) {
                                                                                                    echo 'selected';
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="<?php echo $obUnidade->bairro ?>" id="bairro" name="bairro">
                                        </div>
                                    ...
                                    <div class="col-md-1">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="<?php echo $obUnidade->cidade ?>" id="cidade" name="cidade">
                                        </div>
                                    ...
                                    <div class="col-md-1">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="<?php echo $obUnidade->estado ?>" id="estado" name="estado">
                                        </div>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="<?php echo $obUnidade->endereco ?>" id="endereco" name="endereco">
                                        </div>
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="<?php echo $obUnidade->numero ?>" id="numero" name="numero" placeholder="Número">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="timezone" id="timezone" class="form-control">
                                                ...
                                                <?php foreach ($timezones as $timezone) { ?>
                                                    <option value="<?php echo $timezone ?>" <?php if ($timezone == $obUnidade->timezone) {
                                                                                                echo 'selected';
